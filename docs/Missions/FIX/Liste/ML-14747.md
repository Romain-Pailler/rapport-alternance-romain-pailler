...
Sur la page d’accueil de l’application Leasa, un ensemble de **tuiles informatives** permet de visualiser rapidement l’état d’avancement des différents dossiers de financements : contrats en vie, dossiers à étudier, mises en place, etc. Parmi celles-ci, la tuile **"Contrats en relocation"** affiche le nombre de dossiers en cours de traitement dans le cadre d’une relocation.
