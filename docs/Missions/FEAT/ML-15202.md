...
Afin de faciliter l'accès à l'information, la date de prélèvement est désormais **affichée directement dans l'interface** de consultation de la [pièce comptable](../../glossaire/Vocab_metier.md#pièce-comptable), **uniquement si le [mode de paiement](../../glossaire/Vocab_metier.md#mode-de-paiement) est "Prélèvement"**.
